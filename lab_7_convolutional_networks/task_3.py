...
def do_test(pooling_layer):
    ...
    model.add(pooling_layer(pool_size=pooling_size))
    model.add(Flatten())
...
score_max_pooling = do_test(MaxPooling2D)
score_avg_pooling = do_test(AveragePooling2D)
